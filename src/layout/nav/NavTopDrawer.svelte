...
<script lang="ts">
  ...
  import { checkSubscription, serviceWorkerUnregister, subscribeToNotifications, unsubscribeFromPush, serviceWorkerSound, notificationSound, notificationSoundVolume, updateVolume, onSound, setSwSubscription, sw_subscription } from "~/utils/pushNotification";
